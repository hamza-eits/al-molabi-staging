        ...
        <div class='row'>
          ...
          <tbody>
            ...
            <tr class="p-3">
              ...
              <td> <select name="SupplierID[]" id="SupplierID_{{$no}}" class=" form-select select2 changesNo" onchange="ajax_balance(this.value);">
...
$(".addmore").on('click',function(){
  ...
  html += '<td><select name="ItemID0[]" id="ItemID0_'+i+'" class="form-select changesNoo"> @foreach ($items as $key => $value) <option value="{{$value->ItemID}}" data-tax="{{$value->Percentage ?? 0}}">{{$value->ItemCode}}-{{$value->ItemName}}-{{$value->Percentage}}</option>@endforeach</select></td>';
  ...
  html += '<td><select name="SupplierID[]" id="SupplierID_'+i+'"  onchange="ajax_balance(this.value);" class="js-example-basic-single form-select select2">  @foreach ($supplier as $key => $value)     <option value="{{$value->PartyID}}">{{$value->PartyType}}-{{$value->PartyID}}-{{$value->PartyName}}</option>                @endforeach</select></td>';
