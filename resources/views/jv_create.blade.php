                  ...
                  <table style="border-collapse: collapse;" cellspacing="0" cellpadding="0">
                    <thead>
                      <tr class="bg-light borde-1 border-light " style="height: 40px;">
                        ...
                        <th width="12%" class="d-none">Supplier</th>
                        <th width="12%">Party / Suppliers</th>
                    ...
                    <tbody>
                      <tr class="bg-light border-1 border-light">
                        ...
                        <td class="d-none"> <select name="SupplierID[]" id="SupplierID_1" class="   form-select select2"
                      ...
                      <tr class="bg-light border-1 border-light">
                        ...
                        <td class="d-none"> <select name="SupplierID[]" id="SupplierID_2" class=" select2 supplier form-select "
                            onchange="ajax_balance(this.value);">
                            <option value="">Select Supplier</option>
...
$(".addmore").on('click',function(){
  ...
  html += '<td class="d-none"><select name="SupplierID[]" id="SupplierID_'+i+'"  onchange="ajax_balance(this.value);" class="form-select supplier select2"> <option value="">Select Supplier</option>@foreach ($supplier as $key => $value) <option value="{{$value->SupplierID}}">{{$value->SupplierName}}</option>@endforeach</select></td>';
