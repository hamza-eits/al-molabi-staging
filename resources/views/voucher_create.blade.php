                      ...
                      <tbody>
                        ...
                        <td> <select name="BranchID[]" id="SupplierID_1" class="   form-select select2 supplier" onchange="ajax_balance(this.value);">
                         ...
                         <td> <select name="PartyID[]" id="PartyID_1" class=" row-party-id   form-select select2 party" onchange="ajax_balance(this.value);">
                          ...
                          <option value="{{$value->PartyID}}">{{$value->PartyType}}-{{$value->PartyID}}-{{$value->PartyName}}</option>
                          @endforeach
                        </select>
                      </td>
                      <td>
...
html += '<td><select name="BranchID[]" id="SupplierID_'+i+'" class="   form-select select2 supplier" onchange="ajax_balance(this.value);">                        <option value="">Select Branch</option>                          @foreach ($branch as $key => $value)                          <option value="{{$value->id}}">{{$value->name}}</option>                          @endforeach                        </select></td>';
