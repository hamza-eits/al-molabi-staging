...
$average= $revenue[0]->Balance/$diff;
    ...
    ->first();
     ...
     return view('dashboard', compact('pagetitle', 'v_cashflow', 'invoice_master', 'expense', 'revenue', 'profit_loss', 'cash', 'cash1', 'exp_chart', 'party_balance', 'ticket_register', 'avg','sale_report','average','invoice_summary','monthly_income','today_sale','bankCharges'));
  }
