          ...
          <div class="card shadow-sm">
            <div class="card-body">
              ...
              <form action="<?php echo e(URL('/PartyWiseSale1')); ?>" method="post" name="form1" id="form1"> <?php echo e(csrf_field()); ?>
                ...
                <div class="col-md-4">
                  <div class="mb-0">
                    <label for="basicpill-firstname-input">Customer / Supplier</label>
                    <select name="PartyID" id="" class="select2 form-select" id="select2-basic">
                      <option value="0">Select</option>
                      <?php foreach ($party as $key => $value): ?>
                      <option value="<?php echo e($value->PartyID); ?>"><?php echo e($value->PartyID); ?>-<?php echo e($value->PartyType); ?>-<?php echo e($value->PartyName); ?></option>
...
<?php echo $__env->make('tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/rotana_sky/resources/views/reports/partywise_sale.blade.php ENDPATH**/ ?>