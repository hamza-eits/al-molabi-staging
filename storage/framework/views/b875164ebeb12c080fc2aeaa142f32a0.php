                            ...
                            <tbody>
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($item->logo): ?>
                                                <img src="<?php echo e(asset('storage/' . $item->logo)); ?>" alt="Logo" width="50" height="50">
                                            <?php else: ?>
                                                N/A
                                            <?php endif; ?>
                                        </td>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('branch.update')); ?>" method="post" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-12">
        ...
        function edit_branch(id) {
            ...
            success: function(response) {
                ...
                if (response.data.logo) {
                    $('#update_logo').after('<img src="<?php echo e(asset('storage/')); ?>/' + response.data.logo + '" alt="Logo" width="50" height="50" class="mt-2">');
                }
...
<?php echo $__env->make('template.tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/rotana_sky/resources/views/branches/index.blade.php ENDPATH**/ ?>