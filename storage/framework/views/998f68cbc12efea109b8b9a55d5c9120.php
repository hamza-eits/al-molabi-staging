                ...
                <div class="row">
                  <div class="col-6"> <img src="<?php echo e(asset('documents/'.$company->Logo)); ?>" alt="">
                   ...
                   <select name="PartyID" id="PartyID" class="form-select select2 mt-5" required="">
                        ...
                        <option value="<?php echo e($value->PartyID); ?>" <?php echo e(($value->PartyID== session::get('PartyID')) ? 'selected=selected':''); ?> ><?php echo e($value->PartyID); ?>-<?php echo e($value->PartyName); ?>-<?php echo e($value->Phone); ?>
...
<?php echo $__env->make('template.tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/al-molabi/resources/views/umrah/umrah_create.blade.php ENDPATH**/ ?>