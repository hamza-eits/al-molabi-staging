        ...
        <div class='row'>
          ...
          <tbody>
            ...
            <tr class="p-3">
              ...
              <td> <select name="SupplierID[]" id="SupplierID_<?php echo e($no); ?>" class=" form-select select2 changesNo" onchange="ajax_balance(this.value);">
                    ...
                    <option value="<?php echo e($value->PartyID); ?>" <?php echo e(($value->PartyID== $value1->SupplierID) ? 'selected=selected':''); ?>><?php echo e($value->PartyType); ?>-<?php echo e($value->PartyID); ?>-<?php echo e($value->PartyName); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                 </select>
...
<script>
  ...
  $('#invoice_form').on('submit', function(e) {
          ...
          $.ajax({
              type: "POST",
              url: "<?php echo e(URL('/InvoiceSave')); ?>", // Server-side validation route
              dataType: 'json',
              contentType: false,
              processData: false,
              cache: false,
...
<?php echo $__env->make('tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/al-molabi/resources/views/invoice_refund.blade.php ENDPATH**/ ?>