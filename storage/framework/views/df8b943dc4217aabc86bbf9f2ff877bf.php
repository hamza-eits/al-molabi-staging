<script>
        ...
        function submitUmrahInvoiceVoucher(formData)
        {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('umrah-invoice-voucher-store')); ?>",
                dataType: 'json',
                contentType: false,
                processData: false,
                cache: false,
...
// });
 ...
 <?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/rotana_sky/resources/views/umrah/invoice_masters/js/umrah_invoice_voucher.blade.php ENDPATH**/ ?>