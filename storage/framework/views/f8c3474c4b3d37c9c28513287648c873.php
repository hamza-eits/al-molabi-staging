...
<div class="table-responsivee">
    ...
    <script>
        let routeName = <?php echo json_encode($routeName, 15, 512) ?>;
        // alert(routeName);
        var table = null;
        $(document).ready(function() {
            table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('location.index')); ?>",
                columns: [
                   {
        data: null,
        name: 'serial',
        ...
        searchable: false
            ...
            $('#create-update-form').on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('location.store')); ?>",
                    dataType: 'json',
                    contentType: false,
                    processData: false,
                    cache: false,
        ...
        function editRecord(id) {
            $.get("<?php echo e(route('location.edit', ':id')); ?>".replace(':id', id), function(response) {
        ...
        function deleteRecord(id) {
            if (confirm("Are you sure you want to delete?")) {
                $.ajax({
                    type: 'DELETE',
                    url: "<?php echo e(route('location.destroy', ':id')); ?>".replace(':id', id),
                    data: {
...
<?php echo $__env->make('template.tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/rotana_sky/resources/views/locations/index.blade.php ENDPATH**/ ?>