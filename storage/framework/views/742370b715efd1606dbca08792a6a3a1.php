        ...
        <div class="page-content">
            ...
            <div class="col-md-3 mt-1">
                ...
                <select class="form-select select2" id="visa_type" name="visa_type">
                    ...
                    <?php $__currentLoopData = $visa_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($row->visa_type); ?>"><?php echo e($row->visa_type); ?></option>
            ...
            <div class="col-md-3 mt-1">
                ...
                <select class="form-select select2" id="visa_category" name="visa_category">
                    <?php $__currentLoopData = $visa_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($row->visa_category); ?>"><?php echo e($row->visa_category); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('visatariff.index')); ?>",
                columns: [
                   {
        data: null,
        name: 'serial',
        ...
        function createOrUpdate()
        {
             ...
             let formData = new FormData(document.getElementById('create-update-form'));
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('visatariff.store')); ?>",
                    dataType: 'json',
                    contentType: false,
                    processData: false,
                    cache: false,
        ...
        function editRecord(id) {
            $.get("<?php echo e(route('visatariff.edit', ':id')); ?>".replace(':id', id), function(response) {
        ...
        function deleteRecord(id) {
            if (confirm("Are you sure you want to delete?")) {
                $.ajax({
                    type: 'DELETE',
                    url: "<?php echo e(route('visatariff.destroy', ':id')); ?>".replace(':id', id),
                    data: {
...
<?php echo $__env->make('template.tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/al-molabi/resources/views/visa_tariff/index.blade.php ENDPATH**/ ?>