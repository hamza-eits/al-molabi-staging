                                    ...
                                    <div class="col-sm-9">
                                        <select name="SupplierID" id="SupplierID" class="form-select select2 mt-5"  >
                                            ...
                                            <?php foreach ($supplier as $key => $value) : ?>
                                                <option value="<?php echo e($value->PartyID); ?>" <?php echo e(($value->PartyID== $expense_master[0]->SupplierID) ? 'selected=selected':''); ?>><?php echo e($value->PartyName); ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
...
<?php echo $__env->make('template.tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/rotana_sky/resources/views/expense/expense_edit.blade.php ENDPATH**/ ?>