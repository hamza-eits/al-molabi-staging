...
<script>
  ...
  $('#invoice_form').on('submit', function(e) {
          ...
          $.ajax({
              type: "POST",
              url: "<?php echo e(URL('/InvoiceUpdate')); ?>", // Server-side validation route
              dataType: 'json',
              contentType: false,
              processData: false,
              cache: false,
...
<?php echo $__env->make('tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/rotana_sky/resources/views/invoice_edit.blade.php ENDPATH**/ ?>