    ...
    <div class="container-fluid">
      ...
      <div class="card shadow-sm">
        <div class="card-body">
          ...
          <form action="<?php echo e(URL('/paymentSummary1')); ?>" method="post" name="form1" id="form1"> <?php echo e(csrf_field()); ?>
            ...
            <div class="col-md-4">
              <div class="mb-0">
                ...
                <select name="UserID" id="" class="select2 form-select" id="select2-basic">
                  ...
                  <option value="<?php echo e($value->SalemanID); ?>"><?php echo e($value->SalemanName); ?></option>
...
<script>
  $(document).ready(function(){
    ...
    $('#online').click(function(event){
        event.preventDefault();
        $('#form1').removeAttr('target');
        $('#form1').attr('action', '<?php echo e(URL("/paymentSummary1")); ?>');
        $('#form1').submit();
    });
});
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/rotana_sky/resources/views/reports/payment_summary.blade.php ENDPATH**/ ?>