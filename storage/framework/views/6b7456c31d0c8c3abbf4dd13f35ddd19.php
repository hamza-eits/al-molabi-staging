                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select select2" id="hotel_name" name="hotel_name">
                                    ...
                                    <option value="<?php echo e($row->id); ?>"><?php echo e($row->hotel_name); ?></option>    
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('hoteltariff.index')); ?>",
                columns: [
                   {
        data: null,
        name: 'serial',
        ...
        searchable: false
            ...
            $('#create-update-form').on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('hoteltariff.store')); ?>",
                    dataType: 'json',
                    contentType: false,
                    processData: false,
                    cache: false,
  ...
  $('#create-update-modal').on('shown.bs.modal', function() {
    ...
    $('.select2').select2({
        ...
        function editRecord(id) {
            $.get("<?php echo e(route('hoteltariff.edit', ':id')); ?>".replace(':id', id), function(response) {
        ...
        function deleteRecord(id) {
            if (confirm("Are you sure you want to delete?")) {
                $.ajax({
                    type: 'DELETE',
                    url: "<?php echo e(route('hoteltariff.destroy', ':id')); ?>".replace(':id', id),
                    data: {
...
<?php echo $__env->make('template.tmp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/al-molabi/resources/views/hotel_tariff/index.blade.php ENDPATH**/ ?>