    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('packages.index')); ?>",
                columns: [
        ...
        function editRecord(id) {
            var btn = $('#submit-btn');
            $.get("<?php echo e(route('packages.edit', ':id')); ?>".replace(':id', id), function(response) {
        ...
        function deleteRecord(id) {
            if (confirm("Are you sure you want to delete?")) {
                $.ajax({
                    type: 'DELETE',
                    url: "<?php echo e(route('packages.destroy', ':id')); ?>".replace(':id', id),
                    data: {
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u790884004/domains/xtbooks.cloud/public_html/rotana_sky/resources/views/packages/index.blade.php ENDPATH**/ ?>